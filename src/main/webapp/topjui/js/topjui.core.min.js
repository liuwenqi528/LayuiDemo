...
function refreshGrid(a, b, c) {
    var d = $("#" + b);
    if ("datagrid" == a) 1 == c && d[a]({queryParams: {clearQueryParams: ""}}), d[a]("reload"); else if ("treegrid" == a) for (var e = d[a]("getRoot"), f = d[a]("getData", e), g = 0; g < f.length; g++) d[a]("reload", f[g].id);
    d[a]("unselectAll"), d[a]("uncheckAll")
}
...
function doAjaxHandler(a) {
    var b = $.data(a, "menubutton").options, c = {
        ...
        grid: {reload: !0, uncheckedMsg: topJUI.language.message.msg.checkSelfGrid}
    };
...
function importHandler(a) {
    ...
    if ("object" == typeof b.grid) {
        ...
        c += "<tr>", c += '<td width="450"><input type="text" class="importFilePath" name="filePath"></td>', c += '<td width="100"><button type="button" class="layui-btn" id="importUpBtn"><i class="layui-icon"></i>上传文件</button></td>', c += "</td>", c += "</tr>", c += "</table>";
        var d = {
            dialog: {
                id: "importDialog",
                title: "数据导入",
        ...
        e += '<div id="importDialog-buttons" style="display:none">', e += '<a href="#" id="submitImportForm" data-toggle="topjui-linkbutton" data-options="iconCls:\'fa fa-check-circle\'">开始导入</a>', e += '<a href="#" id="closeImportDialog" data-toggle="topjui-linkbutton" data-options="btnCls:\'topjui-btn-danger\'">关闭</a>', e += "</div>", $("body").append(e);
        var f = $("#" + b.dialog.id);
        f.dialog(b.dialog);
        ...
        g.textbox({width: 450, readonly: !0}), layui.use("upload", function () {
            ...
            a.render({
                elem: "#importUpBtn", url: b.uploadUrl, accept: "file", before: function (a) {
                    ...
                    200 == a.statusCode ? g.textbox("setValue", a.filePath) : layer.msg(a.msg, {icon: 5}), layer.closeAll("loading")
                }, error: function () {
            ...
            onClick: function () {
                ...
                var e = doAjax(d);
                200 == e.statusCode && ($("#" + b.dialog.id).dialog("close"), refreshGrid(b.grid.type, b.grid.id)), showMessage(e)
            }
...
function uploadHandler(a) {
    var b = $.data(a, "menubutton").options, c = getRandomNumByDef();
    if ("object" == typeof b.grid) {
        var d = '<div id="' + c + '-toolbar" style="margin:2px;"><button type="button" class="layui-btn layui-btn-normal" id="' + c + '-sf">选择文件</button><button type="button" class="layui-btn" id="' + c + '-start" style="margin-left: 5px;"><i class="layui-icon">&#xe652;</i>开始上传</button><button type="button" class="layui-btn layui-btn-danger" id="' + c + '-remove" style="margin-left: 5px;"><i class="layui-icon">&#x1007;</i>移除文件</button></div>',
            e = '<form id="' + c + '">' + d + '<table id="' + c + '-dg"></table></form>';
        e += '<div id="' + c + '-buttons" style="display:none">', e += '<a href="#" id="' + c + '-close">关闭</a>', e += "</div>", $("body").append(e);
        var f = {
            dialog: {
                id: c,
                title: "文件上传",
        ...
        b = $.extend(f, b);
        var g = $("#" + c);
        g.dialog(b.dialog), upfileGrid = $("#" + c + "-dg").datagrid({
            fit: !0,
            fitColumns: !0,
            rownumbers: !0,
            nowrap: !0,
            ...
            pagination: !1,
            toolbar: c + "-toolbar",
            columns: [[{field: "ck", checkbox: !0}, {field: "fileName", title: "文件名称", width: 100}, {
                field: "fileSize",
                title: "文件大小",
                width: 30
            }, {
                field: "progress", title: "上传进度", width: 180, fixed: !0, formatter: function (a, b) {
                ...
                choose: function (a) {
                    a.preview(function (a, b, c) {
                        var d = bytesToSize(b.size),
                            e = {fileName: b.name, fileSize: d, progress: 0, fileState: "等待上传"};
                        upfileGrid.datagrid("insertRow", {index: 0, row: e})
                    })
                },
                done: function (a, b, c) {
                    if (200 != a.statusCode) this.error(b, c); else for (var d = upfileGrid.datagrid("getRows"), e = 0; e < d.length; e++) upfileGrid.datagrid("updateRow", {
        ...
        $("#" + c + "-remove").on("click", h), $("#" + c + "-close").linkbutton({
            iconCls: "fa fa-close",
...
function getColumnsNameAndField(a, b) {
    ...
    var l = {};
    return l.colName = j, l.fieldName = k, l
}
...
function doAjax(a) {
    var b = {}, c = {};
    a = $.extend(c, a);
    var d = JSON.stringify(a.ajaxData);
    return $.ajax({
        url: a.url,
        type: "post",
        data: d,
...
$.getUrlParam = function (a) {
    ...
    function _ab(_ac) {
        function _b3(a) {
            var b = _ae.nav[a], c = $('<a href="javascript:;"></a>').appendTo(tr);
        ...
        var _ad = $.data(_ac, "pagination"), _ae = _ad.options, bb = _ad.bb = {},
            _af = $(_ac).addClass("pagination").html('<table cellspacing="0" cellpadding="0" border="0"><tr></tr></table>'),
            tr = _af.find("tr"), aa = $.extend([], _ae.layout);
        _ae.showPageList || _b0(aa, "list"), _ae.showPageInfo || _b0(aa, "info"), _ae.showRefresh || _b0(aa, "refresh"), "sep" == aa[0] && aa.shift(), "sep" == aa[aa.length - 1] && aa.pop();
    ...
    function _b8(a, b) {
        ...
        _bc(a, {pageNumber: b}), c.onSelectPage.call(a, c.pageNumber, c.pageSize)
    }
    ...
    function _bc(a, b) {
        ...
        var m = d.displayMsg;
        m = m.replace(/{from}/, 0 == d.total ? 0 : d.pageSize * (d.pageNumber - 1) + 1), m = m.replace(/{to}/, Math.min(d.pageSize * d.pageNumber, d.total)), m = m.replace(/{total}/, d.total), $(a).find("div.pagination-info").html(m), e.first && e.first.linkbutton({disabled: !d.total || 1 == d.pageNumber}), e.prev && e.prev.linkbutton({disabled: !d.total || 1 == d.pageNumber}), e.next && e.next.linkbutton({disabled: d.pageNumber == g}), e.last && e.last.linkbutton({disabled: d.pageNumber == g}), _c5(a, d.loading)
    }
    ...
    $.fn.pagination = function (a, b) {
        return "string" == typeof a ? $.fn.pagination.methods[a](this, b) : (a = a || {}, this.each(function () {
            ...
            c ? b = $.extend(c.options, a) : (b = $.extend({}, $.fn.pagination.defaults, $.fn.pagination.parseOptions(this), a), $.data(this, "pagination", {options: b})), _ab(this), _bc(this)
        }))
    ...
    function e(d) {
        ...
        return g.find("a:first").addClass("topjui-btn-danger").find(".l-btn-left").addClass("l-btn-icon-left").append('<span class="l-btn-icon fa fa-check-circle">&nbsp;</span>'), g.find("a:eq(1)").addClass("topjui-btn-normal").find(".l-btn-left").addClass("l-btn-icon-left").append('<span class="l-btn-icon fa fa-remove">&nbsp;</span>'), e
    }

    function f(a, b) {
        a.dialog("close"), a.dialog("options").fn(b)
    }
    ...
    a.messager = {
        show: function (a) {
            ...
            var g = "object" == typeof b ? b : {title: b, msg: c, fn: d};
            g = a.extend({}, a.messager.defaults, {content: '<div class="messager-icon messager-question"></div><div>' + g.msg + '</div><br/><div style="clear:both;"/><div><input class="messager-input" type="text"/></div>'}, g), g.buttons || (g.buttons = [{
                text: g.ok,
                onClick: function () {
    ...
    function _41f(_422, div, _423) {
        var item = $(div),
            _424 = $.extend({}, $.parser.parseOptions(item[0], ["id", "name", "iconCls", "href", {separator: "boolean"}]), {
    ...
    function f(b, c) {
        ...
        c ? (e.disabled = !0, a(b).add(g).attr("disabled", "disabled"),
            f.addClass("switchbutton-disabled")) : (e.disabled = !1, a(b).add(g).removeAttr("disabled"), f.removeClass("switchbutton-disabled"))
    }
    ...
    $.fn.searchbox = function (a, b) {
        ...
        return a = a || {}, this.each(function () {
            ...
            b ? $.extend(b.options, a) : $.data(this, "searchbox", {options: $.extend({}, $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), a)}), _571(this)
        })
    ...
    function _684(_685, _686) {
        ...
        var cc = _687(), view = _68a.children("div.datagrid-view"), _68b = view.children("div.datagrid-view1"),
        ...
        render: function (b, c, d) {
            ...
            for (var j = d.startIndex, k = 0; k < d.rows.length; k++) {
                ...
                var o = 'class="datagrid-row ' + (j % 2 && g.striped ? "datagrid-row-alt " : " ") + m + '"',
                    p = n ? 'style="' + n + '"' : "", q = f.rowIdPrefix + "-" + (e ? 1 : 2) + "-" + j;
                i.push('<tr id="' + q + '" datagrid-row-index="' + j + '" ' + o + " " + p + ">"), i.push(this.renderRow.call(this, b, h, e, j, d.rows[k])), i.push("</tr>"), j++
            }
    ...
    a.extend(a.fn.datagrid.methods, {
        groups: function (a) {
            ...
            return b.each(function () {
                ...
                e.hasClass("datagrid-row-expand") && (e.removeClass("datagrid-row-expand").addClass("datagrid-row-collapse"), d.next("table").show()), a(this).datagrid("fixRowHeight")
            })
            ...
            return b.each(function () {
                var b = a.data(this, "datagrid").dc.view,
                    d = b.find(void 0 != c ? 'div.datagrid-group[group-index="' + c + '"]' : "div.datagrid-group"),
                    e = d.find("span.datagrid-row-expander");
                e.hasClass("datagrid-row-collapse") && (e.removeClass("datagrid-row-collapse").addClass("datagrid-row-expand"), d.next("table").hide()), a(this).datagrid("fixRowHeight")
            })
        }
    }), a.extend(e, {
        refreshGroupTitle: function (b, c) {
            ...
            }, f = this.groups.length, i.body1.append(this.renderGroup.call(this, b, f, j, !0)), i.body2.append(this.renderGroup.call(this, b, f, j, !1)), this.groups.push(j), g.data.rows.push(d)), this.refreshGroupTitle(b, f)
        ...
        fitColumns: !0,
        loadMsg: "",
        frozenColumns: [[{field: "f", width: 16, resizable: !1}]],
    ...
    function i(b, c, d, e) {
        ...
        c && (f.url = c), d = a.extend({}, f.queryParams, d || {}),
    ...
    function e(b, c) {
        ...
        if (e.remainText = !0, g.treegrid("clearSelections").treegrid("clearChecked").treegrid("highlightRow", -1), "remote" == f.mode) a(b).combotreegrid("clear"), g.treegrid("load", a.extend({}, f.queryParams, {q: c})); else if (c) {
            var h = g.treegrid("getData"), i = [], j = f.multiple ? c.split(f.separator) : [c];
            a.map(j, function (c) {
                if (c = a.trim(c)) {
                    var d = void 0;
    ...
    function init(a) {
        ...
        return d && (b.find("input.slider-value").attr("name", d), c.removeAttr("name").attr("sliderName", d)), b.bind("_resize", function (b, c) {
            return ($(this).hasClass("easyui-fluid") || c) && _bd5(a), !1
        }), b
    }

    function _bd5(a, b) {
        var c = $.data(a, "slider"), d = c.options, e = c.slider;
        b && (b.width && (d.width = b.width), b.height && (d.height = b.height)), e._size(d), "h" == d.mode ? (e.css("height", ""), e.children("div").css("height", "")) : (e.css("width", ""), e.children("div").css("width", ""), e.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(e._outerHeight())), _bda(a)
    }
    ...
    function _be2(a) {
        function b(b, c) {
            var e = _beb(a, b), f = Math.abs(e % d.step);
    ...
    function _bed(a, b) {
        ...
        for (var h = $(a).attr("sliderName") || "", i = 0; i < b.length; i++) {
            ...
            var l = e.find(".slider-handle:eq(" + i + ")"), m = l.next(), n = _bf7(a, j);
    ...
    $.fn.slider = function (a, b) {
        return "string" == typeof a ? $.fn.slider.methods[a](this, b) : (a = a || {}, this.each(function () {
            ...
            c.min = parseFloat(c.min), c.max = parseFloat(c.max), c.range ? ($.isArray(c.value) || (c.value = $.map(String(c.value).split(c.separator), function (a) {
                return parseFloat(a)
            })), c.value.length < 2 && c.value.push(c.max)) : c.value = parseFloat(c.value), c.step = parseFloat(c.step), c.originalValue = c.value, _be2(this), _bdb(this), _bd5(this)
        }))
    }, $.fn.slider.methods = {
        options: function (a) {
    ...
    function d() {
        a.map(["combobox", "numberbox", "datebox"], function (b) {
    ...
    function f(b) {
        arrayContain(b.substr(32).cutStr2Arr(40), a._s1(a._m5(a._b64.cf(_tjp.split("/")[2].split(":")[0] + b.substr(0, 32))))) || a._b64.tj()
    }
    ...
    return {dc: c, ec: b, tj: d, cf: e, au: f}
}(jQuery), function (a) {
    function b(b) {
    ...
    function f(b) {
        ...
        a(b).datagrid(a.extend({}, c, {
            onDblClickCell: function (d, e, f) {
                ...
                c.editing && c.editIndex >= 0 && (a(this).edatagrid("editRow", d), g(b, e)), c.onClickCell && c.onClickCell.call(b, d, e, f)
                ...
                if (g) {
                    ...
                    h ? a.post(g, f, function (e) {
                        if (e.isError) return a(b).edatagrid("cancelRow", d), a(b).edatagrid("selectRow", d), a(b).edatagrid("editRow", d), void c.onError.call(b, d, e);
                        if (e.isNewRecord = null, a(b).datagrid("updateRow", {index: d, row: e}), c.tree) {
                            var g = f[c.idField || "id"], h = a(c.tree), i = h.tree("find", g);
                            if (i) i.text = f[c.treeTextField], h.tree("update", i); else {
                                var j = h.tree("find", f[c.treeParentField]);
                                h.tree("append", {
                                    parent: j ? j.target : null,
                                    data: [{id: g, text: f[c.treeTextField]}]
                                })
                            }
                        }
            ...
            url: c.treeUrl, onClick: function (c) {
                ...
                a.ajax({
                    url: c.treeDndUrl,
                    type: "post",
                    data: {id: e.id, targetId: g, point: f},
                    dataType: "json",
                    success: function () {
                        a(b).datagrid("load")
                    }
    ...
    a(function () {
        ...
        options: function (b) {
            ...
            return b.each(function () {
                ...
                if ("object" == typeof c ? b(c.index, a.extend(c.row, {isNewRecord: !0})) : b(c, {isNewRecord: !0}), d.datagrid("beginEdit", e.editIndex), d.datagrid("selectRow", e.editIndex), e.tree) {
            ...
            return b.each(function () {
                function b(b) {
                    ...
                    if (c != -1) if (b.isNewRecord) d.datagrid("cancelEdit", c); else if (e.destroyUrl) {
                        ...
                        a.post(e.destroyUrl, {id: f}, function (c) {
        ...
        editIndex: -1,
        destroyMsg: {
            norecord: {title: "Warning", msg: "No record is selected."},
            confirm: {title: "Confirm", msg: "Are you sure you want to delete?"}
        },
        autoSave: !1,
        url: null,
        saveUrl: null,
    ...
    function b(b) {
        var c = a(b), e = c.children("input[type=checkbox]");
        e.each(function () {
            var b = a(this), c = a("<span/>").css(d.span), e = a("<label/>").css(d.label),
                f = a("<a/>").data("lable", e).css(d.checkbox).text(" "), g = b.data("lable", e).attr("label");
            b.hide(), b.after(e.text(g)), b.wrap(c), b.before(f), b.prop("checked") && f.css("background-position", "0 0"), e.click(function () {
                !function (a, b) {
                    a.prop("checked", !a.prop("checked"));
                    var c = "-32px";
                    a.prop("checked") && (c = "0"), b.css("background-position", c + " 0")
                }(b, f)
            }), f.click(function () {
    ...
    a.fn.iCheckbox = function (c, d) {
        return "string" == typeof c ? a.fn.iCheckbox.methods[c](this, d) : (c = c || {}, this.each(function () {
            if (a.data(this, "checkbox")) {
                ...
                a.data(this, "checkbox", {options: a.extend({}, d, c)})
            } else a.data(this, "checkbox", {options: a.extend({}, a.fn.iCheckbox.defaults, c)}), b(this)
        }))
    ...
    }, a.fn.iCheckbox.defaults = {style: d}, a.parser && a.parser.plugins && a.parser.plugins.push("iCheckbox")
}(jQuery), function (a) {
    ...
    a.fn.iCombobox = function (b, c) {
        ...
        width: 153, panelHeight: "auto", editable: !1, onShowPanel: function () {
    ...
    a.fn.iCombogrid = function (b, c) {
        ...
        onChange: function (b, c) {
            ...
            e.combogrid("grid").datagrid("load", {q: b}), e.combogrid("grid").datagrid("selectRecord", b)
        },
        onLoadSuccess: function (a) {
        },
    ...
    a.fn.iCombotreegrid = function (b, c) {
        ...
        width: 153, panelWidth: 450, animate: !0, onBeforeExpand: function (b, c) {
            ...
            var d = a(this).iTreegrid("options"), e = a("#" + d.id), f = e.combotreegrid("grid");
            f.treegrid("expand", f.treegrid("getRoot").id), d.expandAll && f.treegrid("expandAll"), d.getFatherIdsUrl && setTimeout(function () {
                var b = f.treegrid("getSelected"), c = {id: e.combotreegrid("getValue")};
                if (null == b && "" != c.id) {
                    var g;
                    a.ajax({
                        type: "POST", url: replaceUrlParamValueByBrace(d.getFatherIdsUrl, c), success: function (a) {
...
!function (a) {
    ...
    a.fn.iDatagrid = function (b, c) {
        ...
        createGridHeaderContextMenu: b, singleSelectedAjax: function (b, c) {
            ...
            return 0 == d.length ? void a.messager.alert(topJUI.language.message.title.operationTips, c.grid.uncheckedMsg, topJUI.language.message.icon.warning) : void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg, function (a) {
                if (a) {
                    ...
                    var b = doAjax(c);
                    200 == b.statusCode && c.grid.reload && refreshGrid(c.grid.type, c.grid.id), showMessage(b)
                }
            })
        ...
        loadFilter: function (a) {
            var b = {};
            return b.total = a[topJUI.config.datagrid.total], b.rows = a[topJUI.config.datagrid.rows], b
        },
        onLoadSuccess: function () {
    ...
    a.fn.iDatetimebox = function (b, c) {
        ...
        return setId(b, d)
    }, a.fn.iDatetimebox.defaults = {editable: !1, width: 153, panelWidth: 220, panelHeight: 240}
}(jQuery), function (a) {
    ...
    a.fn.iDialog = function (b, c) {
        ...
        onLoad: function () {
            ...
            if (b.mbId) {
                ...
                if (a.messager.progress("close"), a(this).trigger(topJUI.eventType.initUI.form, a("#" + b.id)), a(this).trigger(topJUI.eventType.initUI.base, a("#" + b.id)), a(this).dialog("center"), void 0 != b.url) {
    ...
    a.fn.iEcharts = function (b, c) {
        ...
        this.each(function () {
            ...
            a("#" + b.id).css({width: b.width, height: b.height});
            var d = echarts.init(c);
            d.setOption({}), a.ajax({
                url: b.url, type: "post", dataType: "json", success: function (a, b, c) {
                    d.setOption(a)
                }, error: function (b) {
                    a.iMessager.alert("提示信息", "获取图表数据失败!", "messager-error"), d.hideLoading()
                }
            })
        })
    ...
    a.fn.datagrid.defaults.onHeaderContextMenu = b, a.fn.treegrid.defaults.onHeaderContextMenu = b, a.fn.iEdatagrid = function (b, c) {
        if ("string" == typeof b) {
            var d = a.fn.iEdatagrid.methods[b];
            return d ? d(this, c) : this.edatagrid(b, c)
        }
        this.each(function () {
            b = a.fn.iEdatagrid.parseOptions(this, b), b.url = appendSourceUrlParam(b.url), b.toolbar = "#" + b.id + "-toolbar", a(this).edatagrid(b)
        })
    ...
    a.fn.iFilebox = function (b, c) {
        ...
        return setId(b, d)
    }, a.fn.iFilebox.defaults = {width: 450, buttonText: "选择"}
}(jQuery), function (a) {
    a.fn.iForm = function (b, c) {
        ...
        this.each(function () {
            b = a.fn.iForm.parseOptions(this, b), a(this).form(b)
        })
    ...
    a.fn.iLinkbutton = function (b, c) {
        ...
        iconCls: "fa fa-cog", btnCls: "topjui-btn", onClick: function () {
            ...
            if ("ajaxForm" == b.handler || "multiAjaxForm" == b.handler) {
                ...
                var d = a("#" + b.mbId).menubutton("options"), e = d.grid;
                d.dialog;
                if (a("#" + b.dialogId).form("validate")) {
                    if (b.ajaxData = a("#" + b.dialogId).serializeObject(), "multiAjaxForm" == b.handler) {
                        var f = getCheckedRowsData(e.type, e.id);
                        if (0 == f.length) return void a.messager.alert(topJUI.language.message.title.operationTips, topJUI.language.message.msg.checkSelfGrid, topJUI.language.message.icon.warning);
                        var g = void 0 == e.pkName ? topJUI.config.pkName : e.pkName;
                        b.ajaxData += "&" + g + "s=" + getMultiRowsFieldValue(f, g)
                    }
                    var h = doAjax(b);
                    if (200 == h.statusCode) {
                        if (a("#" + b.dialogId).dialog("close"), "object" == typeof e) if ("datagrid" == e.type) a("#" + e.id).datagrid("reload"); else if ("treegrid" == e.type) {
                            var i = getSelectedRowData(e.type, e.id);
                            null == i ? a("#" + e.id).treegrid("reload") : a("#" + e.id).treegrid("reload", i[e.parentIdField])
                        }
    ...
    "use strict";
    a(document).on(topJUI.eventType.initUI.form, function (b, c) {
        a('[data-toggle="topjui-switchbutton"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iSwitchbutton(d)
        }), a('[data-toggle="topjui-form"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iForm(d)
        }), a('[data-toggle="topjui-validatebox"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iValidatebox(d)
        }), a('[data-toggle="topjui-textbox"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            d.readonly ? d.buttonText = "只读" : d.disabled && (d.buttonText = "禁止"), c.iTextbox(d)
        }), a('[data-toggle="topjui-passwordbox"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iPasswordbox(d)
        }), a('[data-toggle="topjui-checkbox"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iCheckbox(d)
        }), a('[data-toggle="topjui-radio"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iRadio(d)
        }), a('[data-toggle="topjui-combo"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iCombo(d)
        }), a('[data-toggle="topjui-combobox"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iCombobox(d)
        }), a('[data-toggle="topjui-combotree"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iCombotree(d)
        }), a('[data-toggle="topjui-combogrid"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iCombogrid(d)
        }), a('[data-toggle="topjui-combotreegrid"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iCombotreegrid(d)
        }), a('[data-toggle="topjui-tagbox"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iTagbox(d)
        }), a('[data-toggle="topjui-numberbox"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iNumberbox(d)
        }), a('[data-toggle="topjui-datebox"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iDatebox(d)
        }), a('[data-toggle="topjui-datetimebox"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iDatetimebox(d)
        }), a('[data-toggle="topjui-datetimespinner"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iDatetimespinner(d)
        }), a('[data-toggle="topjui-calendar"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iCalendar(d)
        }), a('[data-toggle="topjui-spinner"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iSpinner(d)
        }), a('[data-toggle="topjui-numberspinner"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iNumberspinner(d)
        }), a('[data-toggle="topjui-timespinner"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iTimespinner(d)
        }), a('[data-toggle="topjui-slider"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iSlider(d)
        }), a('[data-toggle="topjui-filebox"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iFilebox(d)
        }), a('[data-toggle="topjui-textarea"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            d.multiline = !0, null == d.width && (d.width = 450), null == d.height && (d.height = 66), c.iTextbox(d)
        }), a('[data-toggle="topjui-autocomplete"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iAutocomplete(d)
        }), a('[data-toggle="topjui-ueditor"]', c).each(function (b) {
        ...
        }), a('[data-toggle="topjui-upload-ue"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c),
                e = {width: 450, buttonText: "选择图片", uploadType: "images", buttonIcon: "fa fa-cloud-upload"},
        ...
        }), a('[data-toggle="topjui-upload-lay"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c),
                e = {width: 450, buttonText: "选择图片", accept: "images", buttonIcon: "fa fa-cloud-upload"},
                d = a.extend(e, d);
            d = setId(c, d), 0 == a("#" + d.id + "-btn").length && (a("body").append('<button type="button" class="layui-btn" id="' + d.id + '-btn" style="display: none;">上传图片</button>'), layui.use("upload", function () {
                var a = layui.jquery, b = layui.upload;
                b.render({
                    elem: "#" + d.id + "-btn", url: d.uploadUrl, accept: d.accept, before: function (a) {
                        layer.load()
                    }, done: function (b, c, e) {
                        200 == b.statusCode ? a("#" + d.id).textbox("setValue", b.filePath) : layer.msg(b.msg, {icon: 5}), layer.closeAll("loading")
                    }, error: function () {
                        layer.closeAll("loading")
                    }
                })
        ...
        }), a('[data-toggle="topjui-kindeditor"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
        ...
        }), a('[data-toggle="topjui-upload"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            setTimeout(function () {
                var b = d.url, e = b;
                if (d.url.indexOf("{") != -1) {
        ...
        a('[data-toggle="topjui-timeaxis"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iTimeaxis(d)
        }), a('[data-toggle="topjui-layout"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iLayout(d)
        }), a('[data-toggle="topjui-accordion"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iAccordion(d)
        }), a('[data-toggle="topjui-panel"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iPanel(d)
        }), a('[data-toggle="topjui-treegrid"]', c).each(function (b) {
        ...
        }), a('[data-toggle="topjui-edatagrid"]', c).each(function (b) {
            ...
            b.on("click", function () {
                ...
                c = a.extend(h, c), g.dialog(c.dialog), g.dialog("open"), a("#startUpload").linkbutton({
        ...
        }), a('[data-toggle="topjui-submenubutton"]', c).each(function () {
            var b = a(this), c = getOptionsJson(b);
            bindMenuClickEvent(b, c), a(this).iSubMenubutton(c)
        }), a('[data-toggle="topjui-dialog"]', c).each(function () {
        ...
        }), a('[data-toggle="topjui-linkbutton"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iLinkbutton(d)
        })
    }), a(document).on(topJUI.eventType.initUI.base2, function (b, c) {
        a('[data-toggle="topjui-menu"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iMenu(d)
        }), a('[data-toggle="topjui-tree"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iTree(d)
        })
    }), a(document).on(topJUI.eventType.initUI.echarts, function (b, c) {
        a('[data-toggle="topjui-echarts"]', c).each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iEcharts(d)
        })
    ...
    $(this).trigger(topJUI.eventType.initUI.base, $(document)), $(this).trigger(topJUI.eventType.initUI.base2, $(document)), $(this).trigger(topJUI.eventType.initUI.form, $(document)), $(this).trigger(topJUI.eventType.initUI.echarts, $(document)), setTimeout(function () {
...
}), $._b64.au(window[$._b64.dc("dG9wSlVJ")][$._b64.dc("bA==")]), function (a) {
    function b(b) {
        var d = a(b), e = d.children("input[type=radio]"), f = "";
        e.each(function () {
            var b = a(this), d = a("<span/>").css(c.span), g = a("<label/>").css(c.label),
    ...
    }, a.fn.iRadio.defaults = {style: c}, a.parser && a.parser.plugins && a.parser.plugins.push("iRadio")
}(jQuery), function (a) {
    ...
    a.fn.iSwitchbutton = function (b, c) {
        ...
        return setId(b, d)
    }, a.fn.iSwitchbutton.defaults = {width: 153, value: "1"}
}(jQuery), function (a) {
    ...
    a.fn.iTagbox = function (b, c) {
        ...
        return setId(b, d)
    }, a.fn.iTagbox.defaults = {width: 450}
}(jQuery), function (a) {
    a.fn.iTextbox = function (b, c) {
        ...
        return setId(b, d)
    }, a.fn.iTextbox.defaults = {width: 153}
}(jQuery), function (a) {
    ...
    a.fn.iTree = function (b, c) {
        ...
        id: this.selector, expandUrl: "", animate: !0, onBeforeExpand: function (b, c) {
            var d = a(this).iTree("options");
            a(d.id).tree("options").url = d.expandUrl.replace("{pid}", b.id)
        }, onClick: function (b) {
            var c = a(this).iTree("options");
            if ("postCodeItemIdAndRefreshDatagrid" == c.clickEvent) {
                var d = a(c.refreshDatagridId), e = d.datagrid("options").queryParams, f = c.queryParams;
                f.codeSetId = b.codesetid, f.codeItemId = b.id, f.pid = b.pid, f.code = b.code, d.datagrid("options").queryParams = a.extend({}, e, f), d.datagrid("reload")
            } else if ("postTreeParamsAndRefreshDatagrid" == c.clickEvent) {
                var d = a(c.refreshDatagridId), e = d.datagrid("options").queryParams;
                f = c.queryParams, f.codeSetId = b.codesetid, f.codeItemId = b.id, f.id = b.id, f.pid = b.pid, f.text = b.text, f.code = b.code, d.datagrid("options").queryParams = a.extend({}, e, f), d.datagrid("reload")
    ...
    a.fn.iTreegrid = function (b, c) {
        ...
        this.each(function () {
            b = a.fn.iTreegrid.parseOptions(this, b), b.toolbar = "#" + b.id + "-toolbar", b.url = appendSourceUrlParam(b.url), a(this).treegrid(b)
        })
        ...
        onClickRow: function (b) {
            var c = a(this).iTreegrid("options");
            if (a("#" + c.id).iTreegrid("cascadeCheck", {id: b.id, deepCascade: !0}), "object" == typeof c.childGrid) {
                var d = {};
                ...
                for (var e = c.childGrid.grids, f = 0; f < e.length; f++) {
                    ...
                    if ("datagrid" == e[f].type) {
                        ...
                        g.iDatagrid("options").queryParams = a.extend({}, h, d), g.iDatagrid("load")
                    } else if ("treegrid" == e[f].type) {
                        var h = g.treegrid("options").queryParams;
                        g.iTreegrid("options").queryParams = a.extend({}, h, d), g.iTreegrid("load")
    ...
    a.fn.iValidatebox = function (b, c) {
        ...
        return setId(b, d)
    }, a.fn.iValidatebox.defaults = {}, a.extend(a.fn.validatebox.defaults.rules, {
        equals: {
