...
function changeTheme(themeName) {/* 更换主题 */
    ...
    var themeHrefNew = themeHref.substring(0, themeHref.indexOf('themes')) + '/topjui/themes/default/topjui.' + themeName + '.css';
    // 更换主页面风格
    ...
    if ($iframe.length > 0) {
        for (var i = 1; i < $iframe.length; i++) {
            ...
            var iframeThemeHrefNew = iframeThemeHref.substring(0, iframeThemeHref.indexOf('themes')) + '/topjui/themes/default/topjui.' + themeName + '.css';
